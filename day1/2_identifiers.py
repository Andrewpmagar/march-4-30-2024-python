...
#1. Identifiers can't start with a number. They shuld lways start with A-Z or a-z
# 1a = 12 # this is an error.
a = 12
    # But it may occur somewhere in between

a12 = 12 # this is valid
...
# Identifiers can't contain special symbols, !, @, # etc
# a@ = 12 this is an error

# 4. Identifiers can't be keywords

# def = 12 not allowed because def is a keyword to create a funtion in python
